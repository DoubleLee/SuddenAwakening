...
\hyperlink{class_level}{Level} ctor. 


\begin{DoxyParams}{Parameters}
{\em level\-I\-D} & The I\-D for what level it is. \\
\hline
\end{DoxyParams}
...
Draw pure virtual call to a child class. 
...
Get\-I\-D getter for the level I\-D. 
...
Load\-From\-X\-M\-L is for loading levels from xml files. 


\begin{DoxyParams}{Parameters}
{\em file} & File name and path to an xml file from Tiled map editor. \\
\hline
\end{DoxyParams}
...
Process\-Event is where operating system events are processsed. 


\begin{DoxyParams}{Parameters}
{\em event} & The sfml event type for processing. \\
\hline
\end{DoxyParams}
...
Update pure virtual call to a child class. 
...
Update\-Player is for updating the player code. 
...
Definition at line 111 of file Level.\-hpp.
...
Definition at line 108 of file Level.\-hpp.
